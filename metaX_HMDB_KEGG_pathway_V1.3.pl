...
use Cwd;
####cmd parameters
my $bin="/ifs5/ST_METABO/PMO/2015_project/pipeline/PathwayBinMetaX";
...
`sh $bin/diff_pathway_1.3.sh $species $diff $outdir $bin && perl $bin/metaboPath_total_1.3.pl -gff $total -tab $outdir/$species.cpd_ko.tab -kegg /ifs5/ST_METABO/PMO/2015_project/pipeline/database/KEGG81/KEGG81.gff -outdir $outdir &&  perl $bin/metabo_genPathHTML.pl -indir $outdir/total`;
